...
/// <summary>
/// Utilities for the temporaries game variables management.
/// </summary>
public static class TMPGameVariables
{
    #region Properties
    ...
    /// <summary>
    /// Initializes the <see cref="TMPGameVariables"/> class.
    /// </summary>
    static TMPGameVariables() { Collection = new Dictionary<string, string>(); }
